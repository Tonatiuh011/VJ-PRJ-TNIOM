...
namespace Edgar.Unity.Examples.PC2D
{
    ...
    public class PlatformerMotor2D : MonoBehaviour
    {
        ...
        {
            get { return IsDashing() ? _dashing.dashDir * GetDashSpeed() : _velocity; }
            set { _velocity = value; }
        }
        ...
        {
            get { return IsDashing() ? _dashing.dashDir : Vector2.zero; }
        }
        ...
        {
            get { return IsDashing() ? _dashing.distanceDashed : 0; }
        }
        ...
        {
            get { return IsDashing() ? _dashing.distanceCalculated : 0; }
        }
